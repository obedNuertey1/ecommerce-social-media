export const schemas = [
    ...
    ,
    { sheetName: "Orders", shape: ["phone", "items", "total", "orderId", "status", "dateCreated", "dateModified", "fullName", "address", "city", "stateOrRegion", "ZipOrPostalCode", "shippingMethod", "whatsapp", "currency"] }
    ,
    { sheetName: "NewOrders", shape: ["phone", "items", "total", "orderId", "status", "dateCreated", "dateModified", "fullName", "address", "city", "stateOrRegion", "ZipOrPostalCode", "shippingMethod"] },
