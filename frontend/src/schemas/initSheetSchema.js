export const schemas = [
    ...
    { sheetName: "Products", shape: ["name", "price", "currency", "color", "size", "brand", "category", "material", "availability", "condition", "shipping_weight", "shipping_weight_unit", "custom_label_0", "productCatalogueId", "inventoryQuantity", "description", "mediaFolderId", "mediaIds", "postId", "productId", "facebookPostId", "facebookProductId", "facebookCatalogueId", "instagramPostId", "instagramProductId", "instagramCatalogueId", "threadsPostId", "analytics", "biddable", "bidderEmail", "bidDate", "sale_price", "sale_price_effective_date", "gtin", "mpn", "gender", "age_group", "pattern", "size_type", "size_system", "product_type", "tax", "custom_label_1", "custom_label_2", "custom_label_3", "custom_label_4", "commerce_tax_category", "retailer_id"] }
    ,
